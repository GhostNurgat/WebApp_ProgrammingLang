    ...
    public partial class InitializeDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProgrammingLanguageTypes", x => x.ID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProgrammingLanguages_ProgrammingLanguageTypes_TypeID",
                        column: x => x.TypeID,
                        principalTable: "ProgrammingLanguageTypes",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkLikes", x => new { x.WorkID, x.UserID });
                    table.ForeignKey(
                        name: "FK_WorkLikes_AspNetUsers_UserID",
                        column: x => x.UserID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_WorkLikes_Works_WorkID",
                        column: x => x.WorkID,
                        principalTable: "Works",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FileText = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    FileTask = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserID = table.Column<int>(type: "int", nullable: false),
                    DateLoad = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProgrammingLanguages_TypeID",
